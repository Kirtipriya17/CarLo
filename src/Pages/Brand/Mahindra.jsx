...
export default function Mahindra() {
  return (
    <div>
      ...
      />
         <CarCards link={"/"} image={h1} brand={"Mahindra"} car={"Mahindra Thar"} price={"₹ 11.25 - 17.20 Lakh"} fuelType={"Petrol/Diesel"} mileage={"11.6 - 14.9"} transmission={"Manual/ Automatic (TC)"}
      />
