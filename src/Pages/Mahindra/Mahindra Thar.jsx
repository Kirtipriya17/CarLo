...
{/* <div className="container mx-auto">
  <Slider images={images} />
        ...
        <Props imagesArray={[H1,H2,H3]} brand={"Mahindra"}
        images={images}
        data={['hi']} pic1={H1} pic2={H2} pic3={H3} Car={"Mahindra Thar"} Price={"Rs 100000"}
