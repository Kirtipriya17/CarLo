...
export default function About() {
  return (
    <div className="abt-section">
      ...
      <button className="button-1 abt-btn bg-transparent  hover:bg--500 text-white hover:text-white text-2xl font-bold py-9 px-20  rounded-sm transition duration-300 ease-in-out">
        <Link to={"./Brandslider"}></Link>Buy Now
      </button>
    </div>
  );
}
